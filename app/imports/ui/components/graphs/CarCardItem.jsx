...
class graphCardItem extends React.Component {

  render() {
    const graphDocs = Graphs.find(this.props.car.carId).fetch();
    // console.log(carDocs);
        ...
        <Card.Content>
          <Grid>
            <Grid.Row columns={carDocs.length}>
              {graphDocs.map(recentCar => <Grid.Column key={toString(recentCar.year) + recentCar.make + recentCar._id}>
                <Card>
                  <Card.Content>
...
graphCardItem.propTypes = {
  car: PropTypes.object.isRequired,
};

/** Wrap this component in withRouter since we use the <Link> React Router element. */
export default withRouter(graphCardItem);
